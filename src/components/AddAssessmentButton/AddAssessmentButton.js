...
class AddAssessmentButton extends Component {
    ...
    render() {
        if (!this.props.assessments.find(propsAssessment => propsAssessment.id === this.props.assessment.id) ) {
            ...
            return <div className='assessment-button' key={this.props.assessment.id} title={this.props.assessment.name} id={this.props.assessment.id}> <p title={this.props.assessment.name} id={this.props.assessment.id}> {this.props.assessment.name}</p></div>
          }
          else return (
